...
public class PerfDataSender {
    private static final Logger LOG = LoggerFactory.getLogger(PerfDataSender.class);
     ...
     * @param port a int.
     */
    public PerfDataSender(String host, int port) {
        m_host = host;
        m_port = port;
     ...
     */
    public void addData(String filename, String owner, Long timestamp, Iterable<? extends Double> values) {
    ...
    public void writeData() {
        ...
        try {
            ...
            //TODO Avoid TIME_WAIT when killing the client
        	socket = new Socket();
        	socket.setReuseAddress(true);
        	SocketAddress endpoint=new InetSocketAddress(InetAddressUtils.addr(m_host), m_port);
