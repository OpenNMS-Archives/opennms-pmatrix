 ...
 * @author Craig Gallen
 */
public class PmatrixDashlet extends AbstractDashlet {
    /**
     * wallboard view
     */
     ...
     */
    public PmatrixDashlet(String name, DashletSpec dashletSpec) {
        ...
        if (m_dashletComponent == null) {
            m_dashletComponent = new AbstractDashletComponent() {
                ...
                public void refresh() {
                    ...
                    BrowserFrame browserFrame = new BrowserFrame(null, new ExternalResource("/opennms/vaadin-pmatrix/?uiComponent=" + searchString));
